...
export const Modal = ({ toggleModal, onLogout, user }) => {
  ...
  return (
    <div className="absolute z-20 w-screen h-screen bg-slate-800  bg-opacity-90 flex items-center justify-center pt-16 pr-0 animate__animated animate__fadeIn" onClick={toggleModal} >
